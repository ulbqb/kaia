...
var (
	...
	authorizations = AuthorizationList{{ChainID: 2, Address: common.HexToAddress("0x0000000000000000000000000000000000000001"), Nonce: nonce, V: 0, R: big.NewInt(0), S: big.NewInt(0)}}
)
